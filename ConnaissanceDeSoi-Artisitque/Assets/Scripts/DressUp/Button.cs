...
public class Button : MonoBehaviour {
	...
	public GameObject RideauJaune; 
	public GameObject BandeauNommer;
	...
	void Update() {
		if (naming==true){
			RideauJaune.transform.position = new Vector3(RideauJaune.transform.position.x + ((3.437f-RideauJaune.transform.position.x)/10), RideauJaune.transform.position.y, RideauJaune.transform.position.z);
			BandeauNommer.transform.position = new Vector3(BandeauNommer.transform.position.x, BandeauNommer.transform.position.y + ((3.508f-BandeauNommer.transform.position.y)/10), BandeauNommer.transform.position.z);
		}
	}
